#
#  Be sure to run `pod spec lint LXDownLoaderManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  LXDownLoaderManager is manager
                   DESC

  spec.homepage     = "https://github.com/LIXIANGXLee/LXDownLoaderManager"
  ...
  spec.source       = { :git => "https://github.com/LIXIANGXLee/LXDownLoaderManager.git", :tag => "#{spec.version}" }
  ...
  #
   ...
   spec.public_header_files = "LXDownLoaderManager/LXDownLoaderManager.h",
                              ...
                              "LXDownLoaderManager/LXLoaderFile.h"
